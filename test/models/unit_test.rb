...
class UnitTest < ActiveSupport::TestCase
  ...
  test "available and reserved tomorrow for a week" do
    t1, t2 = 1.day.from_now, 1.week.from_now
    assert_equal 1, Unit.reserved(t1, t2).count
    assert_equal 2, Unit.available(t1, t2).count
  end

  test "available and reserved next week for a month" do
    t1, t2 = 1.week.from_now, (1.week + 1.month).from_now
    assert_equal 2, Unit.reserved(t1, t2).count
    assert_equal 1, Unit.available(t1, t2).count
  end

  test "available and reserved next year for a month" do
